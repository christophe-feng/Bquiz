...
<!-- #newsTitle>table>(tr.tt.ct>td)+(tr.pp*2>td) -->
<div id="newsTitle">
    <table class="all">
        <tr class="tt ct">
            <td>標題</td>
        ...
        <tr class="pp">
            <td style="cursor: pointer;" onclick="$('#newsTitle').hide();$('#news2').hide();$('#news2').show()">年終特賣會開跑了</td>
        </tr>
    </table>
</div>
...
<div id="news1" style="display: none;">
    ...
    <div class="ct">
        <button onclick="$('#newsTitle').show();$('#news1').hide();$('#news2').hide()">返回</button>
    </div>
</div>
